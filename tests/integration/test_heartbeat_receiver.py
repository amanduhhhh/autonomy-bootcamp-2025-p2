...
def read_queue(
    ...
    while not controller.is_exit_requested():
        if not output_queue.queue.empty():
            status = output_queue.queue.get(timeout=QUEUE_READER_TIMEOUT)
...
def main() -> int:
    ...
    # Create your queues
    output_queue = queue_proxy_wrapper.QueueProxyWrapper(mp_manager, QUEUE_MAX)
